...
void D_DFA_Func_NamePhase_Process(M_DFA_Func *dfa_func, const string code, const string word, M_Cursor *cursor);
void D_DFA_Func_ParamPhase_Enter(M_DFA_Func *dfa_func);
void D_DFA_Func_ParamPhase_Process(M_DFA_Func *dfa_func, const string code, const string word, M_Cursor *cursor);
void D_DFA_Func_BlockPhase_Enter(M_DFA_Func *dfa_func);
void D_DFA_Func_BlockPhase_Process(M_DFA_Func *dfa_func, const string code, const string word, M_Cursor *cursor);
